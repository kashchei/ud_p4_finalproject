...
```{r gather_data, echo=FALSE,warning=FALSE}
...
```{r clean full_dataset, echo = FALSE, warning=FALSE}
...
```{r speed vehicles and time, echo = FALSE,warning=FALSE}
...
```{r plot positions, echo=FALSE, warning=FALSE}
...
```{r weather, echo=FALSE,warning=FALSE}
...
```{r finalplots, echo=FALSE, warning=FALSE}
